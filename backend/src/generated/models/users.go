...
type userR struct {
	...
	Tags             TagSlice            `db:"Tags" boil:"Tags" json:"Tags" toml:"Tags" yaml:"Tags"`
...
func (r *userR) GetUserBookStatuses() UserBookStatusSlice {
	if r == nil {
		return nil
	}
...
func (o *User) UserBookStatuses(mods ...qm.QueryMod) userBookStatusQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"user_book_status\".\"user_id\"=?", o.ID),
	)
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadUserBookStatuses(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		...
		qm.WhereIn(`user_book_status.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// Sets related.R.User appropriately.
func (o *User) AddUserBookStatuses(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UserBookStatus) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.UserID = o.ID
