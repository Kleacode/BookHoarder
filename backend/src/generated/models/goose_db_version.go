...
type GooseDBVersion struct {
	...
	VersionID int64     `db:"version_id" boil:"version_id" json:"version_id" toml:"version_id" yaml:"version_id"`
	IsApplied bool      `db:"is_applied" boil:"is_applied" json:"is_applied" toml:"is_applied" yaml:"is_applied"`
	Tstamp    time.Time `db:"tstamp" boil:"tstamp" json:"tstamp" toml:"tstamp" yaml:"tstamp"`

	R *gooseDBVersionR `db:"-" boil:"-" json:"-" toml:"-" yaml:"-"`
	L gooseDBVersionL  `db:"-" boil:"-" json:"-" toml:"-" yaml:"-"`
}
